...
| **Horoscope** | Celestial perspective and daily reflection. Deep violet/blue; luminous zodiac detail; fewer decorative layers than dense current implementations; clear card hierarchy; soft glow over heavy gold ornamentation. | `bg_horoscope_v2` (founder-selected 2026-07-18; `bg_horoscope_v3` imported but unused) |
